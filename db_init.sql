...
INSERT INTO band(id,user_id,name,rating,tags,url) VALUES(1,1,'Metallica',1.0,'','');
INSERT INTO band(id,user_id,name,rating,tags,url) VALUES(2,1,'The Rolling Stones',0.5,'','');
INSERT INTO band(id,user_id,name,rating,tags,url) VALUES(1,2,'Lady Gaga',1.0,'','');
